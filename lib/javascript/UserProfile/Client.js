...
function UserProfile(url, auth, auth_cb) {
    ...
    this.set_user_profile = function (SetUserProfileParams, _callback, _errorCallback) {
    return json_call_ajax("UserProfile.set_user_profile",
        [SetUserProfileParams], 0, _callback, _errorCallback);
};

    this.set_user_profile_async = function (SetUserProfileParams, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("UserProfile.set_user_profile", [SetUserProfileParams], 0, _callback, _error_callback);
    };

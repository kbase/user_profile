...
function UserProfile(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.ver = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "UserProfile.ver",
     ...
     this.filter_users = function (p, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "UserProfile.filter_users",
     ...
     this.get_user_profile = function (usernames, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "UserProfile.get_user_profile",
     ...
     this.set_user_profile = function (p, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "UserProfile.set_user_profile",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "UserProfile.status",
            [], 1, _callback, _errorCallback);
    };
